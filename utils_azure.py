...
def get_completion(prompt, model="gpt-4-32k"):
    ...
    return response
    # [0].message["content"], response.usage['total_tokens']
    ...
    for batch_id, prompt_batch in tqdm.tqdm(
        ...
        while True:
            try:
                ...
                completion_batch = get_completion(prompt=prompt_batch)
                ...
                time.sleep(30)
                print("The Open AI Completion has been paused for 30 secs")
                break
